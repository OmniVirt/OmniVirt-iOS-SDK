...
- (void)receieveMessageWithType:(NSString * _Nonnull)type callback:(void (^ _Nonnull)(BOOL))callback;
- (void)unbindWithType:(NSString * _Nonnull)type callback:(void (^ _Nonnull)(BOOL))callback;
...
- (void)playerMessageReceived:(VRPlayer * _Nonnull)player withName:(NSString * _Nonnull)name andValue:(NSString * _Nonnull)json;
@end
